...
DEFAULT_WEIGHTS: Dict[Regime, Dict[str, float]] = {
    ...
    Regime.CLOSING: {
        ...
        "candle_patterns": 0.30, "technical_analysis": 0.30, "long_put_dip": 0.30,
    },
}
