...
DEFAULT_WEIGHTS: Dict[Regime, Dict[str, float]] = {
    Regime.TREND_LOWVOL: {
        ...
        "vrp": 0.70, "wheel": 0.70, "lstm": 1.20, "claude_ai": 1.10,
    },
    Regime.TREND_HIGHVOL: {
        "momentum": 1.10, "orb": 0.70, "vwap_reversion": 0.50,
        "vrp": 0.80, "wheel": 0.60, "lstm": 0.90, "claude_ai": 0.90,
    },
    Regime.RANGE_LOWVOL: {
        "momentum": 0.60, "orb": 1.00, "vwap_reversion": 1.30,
        "vrp": 1.00, "wheel": 1.00, "lstm": 0.80, "claude_ai": 0.90,
    },
    Regime.RANGE_HIGHVOL: {
        "momentum": 0.50, "orb": 0.90, "vwap_reversion": 1.10,
        "vrp": 1.40, "wheel": 1.30, "lstm": 0.70, "claude_ai": 0.80,
    },
    Regime.OPENING: {
        "momentum": 0.80, "orb": 1.50, "vwap_reversion": 0.80,
        "vrp": 0.60, "wheel": 0.60, "lstm": 0.80, "claude_ai": 0.90,
    },
    Regime.CLOSING: {
        ...
        "vrp": 0.20, "wheel": 0.20, "lstm": 0.30, "claude_ai": 0.30,
    },
}
