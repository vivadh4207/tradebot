                ...
                for pos in open_pos:
                    ...
                    if d and d.should_close:
                        ...
                        reason_human = {
                            ...
                            "tier1_scale_0dte": "0DTE tier-1 scale-out at +5% — locked 1/3, safety net in cash",
                            "tier1_scale_short": "Tier-1 scale-out at +8% — locked 1/3 of position, rest rides",
                            "tier1_scale_swing": "Tier-1 scale-out at +8% — locked 1/3, remainder rides with trailing stop",
                            "tier2_scale_0dte": "0DTE tier-2 scale-out at +10% — locked 2/3, last 1/3 runs with tight stop",
                            "tier2_scale_short": "Tier-2 scale-out at +15% — locked 2/3, remainder rides",
                            "tier2_scale_swing": "Tier-2 scale-out at +15% — locked 2/3, remainder rides",
                            "runner_trail_0dte": "0DTE runner hit adaptive trail — peak caught, locked in with tight give-back",
                            "runner_trail_short": "Short-DTE runner's adaptive trail fired — profit locked at tightened tier",
                            "runner_trail_swing": "Swing runner's adaptive trail fired — rode a big move, now exiting on first real retrace",
